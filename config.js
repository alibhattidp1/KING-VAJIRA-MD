...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : +923164522803';
...
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : +923164522803'; ;
global.devs = "+923164522803"; //Dont change it From here
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'Bhatti-Md',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It' Ali Bhatti`,
  author:  process.env.PACK_AUTHER || '',
  autovoice: process.env.AUTO_VOICE || 'true',
  errorChat : process.env.ERROR_CHAT|| '', // put 'chat' here to send error in chat ,where it accures
  read_status : process.env.AUTO_READ_STATUS || 'false',
  save_status : process.env.AUTO_SAVE_STATUS || 'false',
  packname:  process.env.PACK_NAME || "\t   𓅋 Ali Bhatti𓃮 \n\nᴋɪss ʍᴇ...💋\n\nᴄʟօsᴇ ყσυɾ ᴇყᴇs...👁️🙈\n\nʍɪss ʍᴇ...♥️\n\n\n   -ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ ᴛᴀᴋᴇ 🚮 \n\n--- ρυвʟɪᴄ вσт нᴇʀᴇ ---" ,
  ...
  caption :process.env.CAPTION || "```||◁ᴘᴏᴡᴇʀᴇᴅ ʙʏ Ali Bhatti +923164522803▷||```",   //*『sᴜʙsᴄʀɪʙᴇ • Ali Tech Info』*\n youtube.com/@alibhatti4500"),
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.1.2.2',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'VAJIRA',
  menu : process.env.MENU || '', /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: Bhatti-Md Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/
